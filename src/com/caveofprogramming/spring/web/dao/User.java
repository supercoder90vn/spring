...
public class User implements Serializable {
	...
	/*
	 * In fact, only need to use ValidationGroup for password. 
	 * Not need to  create PersistenceValidationGroup
	 * */
	@Size(min=8,max=15,groups={PersistenceValidationGroup.class,FormValidationGroup.class})
	@Pattern(regexp="^\\w{8,}$",groups={FormValidationGroup.class,FormValidationGroup.class})
	@Id
